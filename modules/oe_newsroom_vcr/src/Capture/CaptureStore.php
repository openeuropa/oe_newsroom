 ...
 *
 * This is used during a replay run, if the recorded VCR data contains
 * placeholder values marked with `!Capture`.
 *
 * The placeholder values are replaced with corresponding actual values. Then
 * the placeholder id and the actual value are collected in this storage, for
 * separate asserting or processing later in the test.
 *
 * @see \Drupal\oe_newsroom_vcr\Capture\CapturingHelper
 */
class CaptureStore {
