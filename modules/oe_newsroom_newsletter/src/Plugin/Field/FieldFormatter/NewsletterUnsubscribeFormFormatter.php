...
/**
 * Field formatter which displays a unsubscription form.
 *
 * @FieldFormatter(
 *   id = "oe_newsroom_newsletter_unsubscribe_form",
 *   label = @Translation("Unsubscribe form"),
 *   field_types = {
 *     "oe_newsroom_newsletter"
 *   }
 * )
 */
class NewsletterUnsubscribeFormFormatter extends FormatterBase {
