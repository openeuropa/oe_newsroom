...
/**
 * Tests the newsletter subscription block configuration validation.
 */
class NewsletterSubscriptionBlockTest extends KernelTestBase {
  ...
  protected function validateEmbedded(array $distribution_lists): array {
    ...
    $block = $this->container->get('plugin.manager.block')
      ->createInstance('oe_newsroom_newsletter_subscription_block', $configuration);
