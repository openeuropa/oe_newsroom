...
class NodeSubscriptionApi {
  ...
  public function unsubscribe(
    ...
    return $this->doUnsubscribe($node_id, $email, NULL);
  }
  ...
  public function requestUnsubscribe(
    ...
    return $this->doUnsubscribe($node_id, $email, $redirect_to);
  }
  ...
  protected function doUnsubscribe(
    ...
    // @todo Is the path correct, or is it 'node-notification/unsubscribe'?
